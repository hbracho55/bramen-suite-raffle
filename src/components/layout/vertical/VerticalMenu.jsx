...
const VerticalMenu = ({ dictionary, scrollMenu }) => {
  ...
  return (
    ...
    >
      ...
      >
        <SubMenu
          label={dictionary['navigation'].request}
          icon={<i className='ri-flashlight-line' />}
          suffix={<Chip label='5' size='small' color='error' />}
        >
          <MenuItem href={`/${locale}/request/dashboard`}>{dictionary['navigation'].dashboard}</MenuItem>
          <MenuItem href={`/${locale}/request/register`}>{dictionary['navigation'].register}</MenuItem>
          <MenuItem href={`/${locale}/request/pending`}>{dictionary['navigation'].pending}</MenuItem>
          <MenuItem href={`/${locale}/request/requested`}>{dictionary['navigation'].requested}</MenuItem>
          <MenuItem href={`/${locale}/request/draft`}>{dictionary['navigation'].draft}</MenuItem>
        ...
        <SubMenu label={dictionary['navigation'].servicecenter} icon={<i className='ri-customer-service-line' />}>
          ...
          <MenuItem href={`/${locale}/servicecenter/register`}>{dictionary['navigation'].register}</MenuItem>
          <MenuItem href={`/${locale}/servicecenter/attention`}>{dictionary['navigation'].attention}</MenuItem>
          <MenuItem href={`/${locale}/servicecenter/activity`}>{dictionary['navigation'].activity}</MenuItem>
