  ...
  customerData: [
    {
      ...
      country: 'Asignar responsable',
      countryFlag: 'No borrar los datos de clientes',
      countryCode: 'Alta',
      order: 'Por favor realizar mantenimiento a la bd',
      totalSpent: 2074.22,
      avatar: '/images/avatars/1.png'
    },
    {
      ...
      country: 'Configurar webhook de pipeline',
      countryFlag: '',
      countryCode: 'Urgente',
      order: 'Por favor configurar el pipeline para el repo del ms-transferenciaspyme',
      totalSpent: 2404.19,
      avatar: '/images/avatars/2.png'
    },
    {
