...
import FormLayoutsRequestFlow from './FormLayoutsRequestFlow'

const FormLayoutsRequestDetails = () => {
  // States
...
export default FormLayoutsRequestDetails
