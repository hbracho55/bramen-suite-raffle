...
const PendingRequestListTable = ({ customerData }) => {
  // States
  ...
  const columns = useMemo(
    () => [
      columnHelper.accessor('id', {
        ...
        cell: ({ row }) => (
          <Typography
            component={Link}
            color='text.primary'
            href={getLocalizedUrl(`/es/request/attend/${row.original.customerId}`, locale)}
      ...
      columnHelper.accessor('tipo', {
        header: 'Tipo',
        cell: ({ row }) => <Typography>Requerimiento</Typography>
      }),
    ...
    <>
      <Card>
        <CardContent className='flex justify-between flex-wrap max-sm:flex-col sm:items-center gap-4'>
          ...
          />
          <div className='flex gap-4 max-sm:flex-col max-sm:is-full'></div>
        </CardContent>
...
export default PendingRequestListTable
