...
import RequestAditionalInformation from './RequestAditionalInformation'
...
const RequestDetails = ({ customerData }) => {
      ...
      <Card className='mb-6'>
        ...
        <CardContent sx={{ padding: '8px' }} className='p-6 bg-actionHover rounded'>
          <Grid container spacing={1}>
            ...
            <Grid item xs={12} sm={12}>
              <RequestAditionalInformation customerData={customerData} />
            </Grid>
          </Grid>
        </CardContent>
      </Card>
